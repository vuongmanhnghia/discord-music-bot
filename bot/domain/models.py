...
class Song:
    ...
    def is_ready(self) -> bool:
        ...
        return (
            self.status == SongStatus.READY and
...
class InputAnalyzer:
    ...
    @classmethod
    def create_song(cls, user_input: str, requested_by: str = None, guild_id: int = None) -> Song:
...
class QueueManager:
    ...
    def __init__(self, guild_id: int):
        ...
        self._repeat_mode: str = "off"  # off, song, queue
